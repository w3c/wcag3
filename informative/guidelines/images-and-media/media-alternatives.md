...
* As a person who relies on sign language, I need important live and recorded audio content to be available in my sign language, not only as written captions, so that I can fully understand it.
* As a person who relies on sign language, I need a prerecorded sign language alternative for important prerecorded audio content.
* As a person who uses sign language, I need to be able to turn the sign language interpretation on and off.
* As a person who uses sign language, I need sign language versions to accurately convey the meaning of the audio content.
* As a person who uses sign language, I need  sign language presentations to be positioned without obscuring important visual content.
* As a person who uses sign language, I need to be able to reposition and resize the sign language window so that I can see both the signer and the content at the same time.
* As a person who uses sign language, I need the signer to be framed showing their head, face, hands and upper torso without cropping so that I can understand the signing.
* As a person who uses sign language, I need interpretations to include prosodic features, such as facial expressions, head movements, and the speed of hand movements,  so that I can understand the intended meaning.
