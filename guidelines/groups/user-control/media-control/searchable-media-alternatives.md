...
2. Check that a mechanism to search and look up terms in transcripts is available. This can be:
  a. copying and pasting content from the transcript into a dictionary; or
  b. allowing a platform or application dictionary to show a definition of the term.
