...
For this foundational level requirement, the default minimum should be roughly equivalent to the WCAG 2 success criterion of a :term[contrast ratio] of at least 4.5:1 for text and at least 3:1 for :term[large-scale] text.
:::
