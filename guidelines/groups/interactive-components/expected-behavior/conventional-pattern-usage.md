...
We assert that :term[interactive components] follow established conventions.
...
- each interactive element follows applicable platform conventions for how users interact with that type of interactive element
- if a component library is used, then each component in the library: 
    - is tested for accessibility before being used, and
    - follows applicable platform conventions for how users interact with that type of interactive element.
:::
